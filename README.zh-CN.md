...
- 从 [最新发布](https://github.com/invented-pro/octodo/releases/latest) 下载 `octodo-v<version>-linux-x64.AppImage`（x86_64）或 `octodo-v<version>-linux-arm64.AppImage`（aarch64）。
- 添加可执行权限后运行：
    ```bash
